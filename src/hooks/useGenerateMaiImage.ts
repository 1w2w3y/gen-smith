...
interface UseGenerateMaiImageResult {
...
export function useGenerateMaiImage(): UseGenerateMaiImageResult {
  ...
  const generate = useCallback(
    async (params: {
      ...
      try {
        const response = await fetch("/api/image/mai/generate", {
          method: "POST",
        ...
        setError(message);
        setImages(null);
        trackClientEvent("ClientMaiImageGenerationError", {
          modelId: params.modelId,
